...
if (empty($_SESSION['klcrm_ok'])) {
    ...
    <form method="post">
      <img class="face" src="assets/kurage-mascot.png" alt="" width="96" height="96">
...
<header>
  <span class="brand"><img src="assets/kurage-mascot.png" alt="" width="30" height="30"><b><?= klcrm_h(KLCRM_TITLE) ?></b></span>
